    ...
    return (
        <main className={'flex flex-col items-center pb-12'}>
            ...
            <section className={'p-3 w-full max-w-175 grid grid-cols-2 gap-3 mt-8'}>
                ...
                <Card title={'About AcidBot'} href={'/pages/about'} newPage={false}>
                    <p>Information on AcidBot</p>
                </Card>

                <Card
                    title={'nearcade'}
                    href={'https://nearcade.cn/?utm_source=acidbot&utm_medium=card&utm_campaign=homepage'}
                    newPage={true}
                >
                ...
                <div className={'grid grid-cols-1 md:grid-cols-3 gap-6 w-full'}>
                    <Card title={'Best 50 Generator'} href={'/pages/b50'}>
                        <p className={'text-sm text-base-content/80'}>
                            Fetch your Best 50 scores to calculate your DX Rating. Instantly generate rating images to
                    ...
                    <Card title={'Skill Radar'} href={'/pages/skill-radar'}>
                        <p className={'text-sm text-base-content/80'}>
                            Discover your playstyle. Analyzes your ability across different patterns like spins, swipes,
                            and more.
                        </p>
                    </Card>
                    ...
                    <Card title={'Level Scores'} href={'/pages/lv-score'}>
                        <p className={'text-sm text-base-content/80'}>
                            Break down your performance by difficulty level. Easily track all your SSS+ grades for
                            levels 1 through 15.
                        </p>
                    </Card>
                </div>

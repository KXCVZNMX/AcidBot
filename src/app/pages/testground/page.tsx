...
function Card() {
    return (
        // pt-1 handles the top spacing
        <div className={'card bg-white w-[265px] h-[110px] rounded-xl pt-1'}>
            {/* mx-auto handles the horizontal centering automatically */}
            <div className={'relative mx-auto bg-[#9e45e2] h-[75px] w-[255px] rounded-t-xl'}>
                ...
                <h1 className={'absolute left-[94px] top-[20px] text-[27px] text-white font-semibold'}>
                    100.9999%
                </h1>
                <p className={'absolute left-[94px] top-[56px] text-white text-xs'}>
                    {'14.6 -> 328'}
                </p>
...
export default function Page() {
    return (
        <div className={'flex justify-center items-center'}>
            <div className={'relative bg-[#6fbaee] w-[1400px] h-[1600px] shrink-0'}>

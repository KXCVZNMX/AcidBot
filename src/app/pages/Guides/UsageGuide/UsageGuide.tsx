    ...
    return (
        <div className={'mx-auto max-w-3xl space-y-6 p-6'}>
            ...
            <Step title={'Step 1 — Login / Signup'}>
                <p>
                    Click the login button on the top right-hand-side corner
                    (or inside the hamburger drawer on the bottom left-hand-side
            ...
            <Step title={'Step 2 — Set your clal token'}>
                <p>
                    Your clal token is required to enable us to fetch your scores.
                    You can learn how to set it in the{' '}
            ...
            <Step title={'Step 3 — Check out the features'}>
                <Step title={'Best 50'} bg={'300'}>
                    <p>
                        ...
                        See each song's level constant, and your results on those
                        songs. {' '}
                ...
                <Step title={'Level Scores'} bg={'300'}>
                    <p>
                        ...
                        and see your results for each song belonging to that level
                        category.{' '}
                ...
                <Step title={'Skill Radar'} bg={'300'}>
                    <p>
                        ...
                        by both patterns (spins, swipes, high-break-counts, etc.),{' '}
                        and chart types (mostly slider, heavy tap counts, etc.). {' '}
